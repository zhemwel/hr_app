...
To make it easy for you to get started with GitHab, here's a list of recommended next steps.
...
```
cd existing_repo
git remote add origin https://github.com/zhemwel/hr_app.git
git branch -M main
...
- [ ] [Set up project integrations](https://github.com/zhemwel/hr_app/-/settings/integrations)
