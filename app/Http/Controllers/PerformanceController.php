...
class PerformanceController extends Controller
{
    ...
    public function index()
    {
        ...
        $indicator = DB::table('performance_indicator_lists')
            ->get();
    ...
    public function saveRecordIndicator(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            Toastr::success('Create New Performance Indicator Success', 'Success');
    ...
    public function updateIndicator(Request $request)
    {
        ...
        try {
            ...
            performanceIndicator::where('id',$request->id)
                ->update($update);
            DB::commit();

            Toastr::success('Performance Indicator Deleted Success', 'Success');
            return redirect()->back();
        } catch(\Exception $e) {
            DB::rollback();
    ...
    public function saveRecordAppraisal(Request $request)
    {
        ...
        try {
            ...
            DB::commit();
            Toastr::success('Create New Performance Appraisal Success', 'Success');
            return redirect()->back();
        } catch(\Exception $e) {
            DB::rollback();
    ...
    public function deleteAppraisal(Request $request)
    {
        try {
            ...
            Toastr::success('Performance Appraisal Deleted Success', 'Success');
            return redirect()->back();
        } catch(\Exception $e) {
            DB::rollback();
    ...
    public function updateAppraisal(Request $request)
    {
        ...
        try {
            ...
            performance_appraisal::where('id',$request->id)
                ->update($update);
            DB::commit();
            Toastr::success('Performance Appraisal Deleted Success', 'Success');
            return redirect()->back();
